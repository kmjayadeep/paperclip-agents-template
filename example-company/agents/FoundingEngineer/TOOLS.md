...
2. **`github` skill** -> branch and worktree management, push, PRs, rebase, review-thread handling, worktree cleanup
3. **`example-project` skill** -> repository conventions and workspace layout
